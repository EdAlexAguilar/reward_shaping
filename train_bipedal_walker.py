...
import callbacks
from utils import make_log_dirs

def main(args):
    args.task = "BipedalWalker-v3"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--reward", type=str, default="default", choices=['indicator', 'indicator_reverse', 'weighted', 'default'])
