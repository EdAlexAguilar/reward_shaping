...
The modifications include the addition of a battery as a 5th observation,
as well as a continuous action space
...
class CartPoleContEnv(gym.Env):
    ...
    def __init__(self, x_threshold=2.4, theta_threshold_deg=24, max_steps=200):
        # Physical Constants
        self.gravity = 9.8
        self.masscart = 1.0
        self.masspole = 0.1
        ...
        self.battery_consumption = 0.01
        self.min_action = -1.0 # np.array(-1.0)
        self.max_action = 1.0 # np.array(1.0)
        ...
        self.state_dim = 5 # dimension of state-space
    ...
    def reset(self):
        """
        x_init is in [-1.5,-0.5] U [0.5,1.5]
        """
