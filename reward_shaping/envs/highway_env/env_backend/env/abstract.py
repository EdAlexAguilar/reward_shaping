...
from reward_shaping.envs.highway_env.env_backend.env.action import action_factory, Action, DiscreteMetaAction, ActionType
from reward_shaping.envs.highway_env.env_backend.env.observation import observation_factory, ObservationType
from reward_shaping.envs.highway_env.env_backend.env.finite_mdp import finite_mdp
from reward_shaping.envs.highway_env.env_backend.env.graphics import EnvViewer
from reward_shaping.envs.highway_env.env_backend.vehicle.behavior import IDMVehicle, LinearVehicle
...
class AbstractEnv(gym.Env):
    ...
    def default_config(cls) -> dict:
        ...
        return {
            ...
            "other_vehicles_type": "reward_shaping.envs.highway_env.env_backend.vehicle.behavior.IDMVehicle",
            "screen_width": 600,  # [px]
