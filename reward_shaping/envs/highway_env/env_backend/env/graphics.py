...
from reward_shaping.envs.highway_env.env_backend.env.action import ActionType, DiscreteMetaAction, ContinuousAction
from reward_shaping.envs.highway_env.env_backend.road.graphics import WorldSurface, RoadGraphics
from reward_shaping.envs.highway_env.env_backend.vehicle.graphics import VehicleGraphics

if TYPE_CHECKING:
    from reward_shaping.envs.highway_env.env_backend.env import AbstractEnv
    from reward_shaping.envs.highway_env.env_backend.env.abstract import Action
...
class ObservationGraphics(object):
    ...
    def display(cls, obs, sim_surface):
        from reward_shaping.envs.highway_env.env_backend.env.observation import LidarObservation
