...
from reward_shaping.envs.highway_env.env_backend.vehicle.dynamics import BicycleVehicle
...
if TYPE_CHECKING:
    from reward_shaping.envs.highway_env.env_backend.road.graphics import WorldSurface
