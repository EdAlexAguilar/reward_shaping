...
class LunarLander(gym.Env, EzPickle):
    ...
    def reset(self):
        ...
        self.obstacle = self.world.CreateStaticBody(shapes=edgeShape(vertices=[self.obstacle_vertices[:2], self.obstacle_vertices[2:]]))
        ...
        print(VIEWPORT_W/SCALE/2, initial_y)
