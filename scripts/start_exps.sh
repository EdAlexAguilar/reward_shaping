...
args=(
  ...
  "lunar_lander land sac ${logdir} 1 hrs_pot 2000000"
  ##
  ## Sequential run of 3 seeds for cartpole baselines tltl, morl_uni, morl_dec
  ##
  "cart_pole_obst fixed_height sac ${logdir} 3 tltl 1000000"
  "cart_pole_obst fixed_height sac ${logdir} 3 morl_uni 1000000"
  "cart_pole_obst fixed_height sac ${logdir} 3 morl_dec 1000000"
  "bipedal_walker forward sac ${logdir} 3 tltl 1000000"
  "bipedal_walker forward sac ${logdir} 3 morl_uni 1000000"
  "bipedal_walker forward sac ${logdir} 3 morl_dec 1000000"
  ##
  ## Parallel run of 3 seeds, 2M steps for bw hardcore
  ##
