...
args=(
  ...
  ## Racecar (Multi-agent)
  ##
  "racecar2 follow_delta sac ${logdir} 1 default ${short_steps} -novideo"
  "racecar2 follow_delta sac ${logdir} 1 hprs ${short_steps} -novideo"
  "racecar2 follow_delta sac ${logdir} 1 tltl ${short_steps} -novideo"
  "racecar2 follow_delta sac ${logdir} 1 bhnr ${short_steps} -novideo"
  "racecar2 follow_delta sac ${logdir} 1 morl_uni ${short_steps} -novideo"
  "racecar2 follow_delta sac ${logdir} 1 morl_dec ${short_steps} -novideo"
)
